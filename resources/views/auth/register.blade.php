...
<div class="max-w-md mx-auto mt-16 p-8 bg-white border-2 border-black rounded-xl text-center shadow-lg">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        {{-- Fields Container with vertical spacing --}}
        <div class="space-y-4">
        ...
        {{-- Submit Button --}}
        <button type="submit"
                class="w-full mt-6 py-3 rounded-full bg-gradient-to-r from-green-400 to-green-600 text-white font-semibold hover:opacity-90 transition">
            Register
        </button>
